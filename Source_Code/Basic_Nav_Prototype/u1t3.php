...
<html lang="en">
  <head>
    ...
    <title>Unit 1 Task 3 - IOLA</title>
				...
				<div class="accordion-body collapse pull-right" id = "t">
					<ul>
						<blockquote style="border-top-left-radius:15px">
							<a href="media/unit1/docs/u1t3.pdf">.pdf Download</a> <br><a href="media/unit1/docs/u1t3.docx">.docx Download</a>
						</blockquote>
					</ul>
				</div>
			...
			<div class="accordion-body collapse" id = "goalsrationale">
				<ul>
					<blockquote>
						...
						<ul>
							<li>The main goal of the problem on the front of Handout 3 - <a data-toggle="collapse" data-target="#handout">Getting Back Home</a> - is to determine if it is possible to use the three given modes of transportation to leave and return back to "home." The problem is stated with modes of transportation in the 3-dimensional world. By the end of the task, linear dependence and linear independence will be formally defined. </li>
