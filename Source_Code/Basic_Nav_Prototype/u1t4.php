...
<html lang="en">
  <head>
    ...
    <title>Unit 1 Task 4 - IOLA</title>
  ...
  <body onload="init()">
    ...
    <div class="container">
      ...
      <div class="jumbotron">
		<div id="sidr">
			<?php $unit = 'u1'; $task = 't4'; include 'sidebar.php' ?>
		</div>
		...
		<div class="jumbotron">
			...
			<a class="btn btn-gray center pull-right" style="margin-right:15px"data-toggle="collapse" data-target="#t">Print Lesson &raquo;</a>
				<div class="accordion-body collapse pull-right" id = "t">
					<ul>
						<blockquote>
							<a href="media/unit1/docs/u1t4.pdf">.pdf Download</a> <br><a href="media/unit1/docs/u1t4.docx">.docx Download</a>
						</blockquote>
					</ul>
				</div>
