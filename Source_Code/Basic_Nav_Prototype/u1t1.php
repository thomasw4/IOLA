...
<html lang="en">
	<head>
		...
		<title>Unit 1 Task 1 - IOLA</title>
			...
			<div class="jumbotron">
				...
				<a class="btn btn-gray center pull-right" style="margin-right:15px"data-toggle="collapse" data-target="#t">Print Lesson &raquo;</a>
					<div class="accordion-body collapse pull-right" id = "t">
						<ul>
							<blockquote>
								<a href="media/unit1/docs/u1t1.pdf">.pdf Download</a> <br><a href="media/unit1/docs/u1t1.docx">.docx Download</a>
							</blockquote>
						</ul>
					</div>
				...
				<div class="accordion" id="summary">		  
					...
					<!-- HANDOUT -->
					<ul>
						<a class="btn btn-warning center" data-toggle="collapse" data-target="#handout1">Handout 1: The Carpet Ride Problem &raquo;</a>
					...
					<a class="btn btn-primary center" data-toggle="collapse" data-target="#implementation">Implementation &raquo;</a>
						<div class="accordion-body collapse" id = "implementation">
							...
							<br><br>
							<a class="btn btn-success center" data-toggle="collapse" data-target="#i1">Discussing Strategies and Answers During Whole Class Discussion &raquo;</a>
							<br>
							...
							<a class="btn btn-success center" data-toggle="collapse" data-target="#i2">Working in small groups towards a solution  &raquo;</a>
							<br>
							...
							<a class="btn btn-success center" data-toggle="collapse" data-target="#i3">Discussing Graphical Representations during Whole Class Discussion &raquo;</a>
							<br>
							...
							<a class="btn btn-success center" data-toggle="collapse" data-target="#i4">Discussing the notion of solution &raquo;</a>
							<br>
